...
<body class="g-sidenav-show bg-gray-100">
    @include('layouts.layouts_backendweb.donatur.donatur_sidebar')

  <main class="main-content position-relative border-radius-lg ">

    @include('layouts.layouts_backendweb.donatur.donatur_header')

    @yield('donatur_content')

    @include('layouts.layouts_backendweb.donatur.donatur_footer')
    </div>
  </main>
