...
<div class="container-fluid py-4">
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <form id="satuan-form" action="{{ URL::route('admin.store-satuan') }}" method="post" role="form">
            <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                <div class="form-group">
                    <label for="satuan" class="form-control-label">Satuan</label>
                    <input id="satuan" name="nama" class="form-control" type="text" value="" placeholder="Masukkan Nama Satuan">
                </div>
                </div>
            </div>
  ...
  <script type="text/javascript">
      $('#satuan-form').on('submit', function(event) {
        ...
        let route_url = "{{ URL::route('admin.store-satuan') }}"
