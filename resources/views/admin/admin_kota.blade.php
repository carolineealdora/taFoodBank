                ...
                <tbody>
                  <tr>
                    ...
                    <td class="align-middle">
                      <a href="{{ URL::route('admin.detail-kota') }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                        Detail
                      </a><br>
                      <a href="{{ URL::route('admin.detail-kota') }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Hapus">
                        Hapus
                      </a>
                    </td>
                  </tr>
