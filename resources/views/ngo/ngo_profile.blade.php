      ...
      <div class="row gx-4">
        <div class="col-auto">
          <div class="avatar avatar-xl position-relative">
            <a href="{{ asset('storage/'.$data['ngo']->pic_foto) }}" data-pswp-width="1669" data-pswp-height="2500">
  ...
  <div class="row">
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="form-group col-md-12">
              ...
              <input class="form-control" type="file" id="picFoto" name="picFoto">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="nama" name="nama" value="{{ $data['pic']->nama }}" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="noIdentitas" class="form-control-label">Nomor Identitas</label>
                <input class="form-control" type="text" id="noIdentitas" name="noIdentitas" value="{{ $data['ngo']->no_identitas }}" required>
              </div>
            </div>
          </div>
    ...
    <script>
      $(document).on('click', '.save', function() {
        let route_url = "{{ URL::route('ngo.editProfile') }}"
